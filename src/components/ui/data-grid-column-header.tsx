...
function DataGridColumnHeader<TData, TValue>({
  ...
  const headerLabel = () => {
    return (
      <div
        className={cn(
          "inline-flex h-full items-center gap-1.5 text-[0.8125rem] font-normal leading-[calc(1.125/0.8125)] text-secondary-foreground/80 [&_svg]:size-4 [&_svg]:opacity-60",
          className,
        )}
      >
        {icon && icon}
  ...
  const headerPin = () => {
    return (
      ...
      >
        <PinOff className="size-4! opacity-50!" aria-hidden="true" />
      </Button>
    );
  };
