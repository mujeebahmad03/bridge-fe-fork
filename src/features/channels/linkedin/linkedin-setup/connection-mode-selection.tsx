...
import type { LinkedInConnectionMode } from "@/types/linkedin";

interface LinkedInConnectionModeSelectionProps {
  onSelectMode: (mode: LinkedInConnectionMode) => void;
}

export function LinkedInConnectionModeSelection({
  onSelectMode,
}: LinkedInConnectionModeSelectionProps) {
  return (
    <div className="space-y-8">
      <div className="space-y-2 text-center">
        <h1 className="text-3xl font-bold">Select Connection Model</h1>
        <p className="text-muted-foreground">
          Choose how you want to connect your LinkedIn accounts
        </p>
      </div>
        ...
        <Card className="group cursor-pointer transition-all duration-200 hover:scale-105 hover:shadow-lg">
          <CardContent className="space-y-6 p-8 text-center">
            ...
            <div className="space-y-3">
              ...
              <p className="text-muted-foreground">
                Connect one LinkedIn account to sync your data.
              </p>
            </div>
            <Button
        ...
        <Card className="group cursor-pointer transition-all duration-200 hover:scale-105 hover:shadow-lg">
          <CardContent className="space-y-6 p-8 text-center">
            ...
            <div className="space-y-3">
              ...
              <p className="text-muted-foreground">
                Connect multiple LinkedIn accounts simultaneously by uploading a
                CSV file.
              </p>
            </div>
            <Button
